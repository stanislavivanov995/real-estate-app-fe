...
export default function Login() {
  // TODO: The users must be able to login with Email and Password
  return (
    <PublicLayout>
      <div className="flex justify-center mt-[3em]">
        <div className="w-[720px] h-[824px] bg-slate-50 flex-col justify-start items-center inline-flex shadow-2xl rounded-tl-[3em] rounded-bl-[3em]">
          <div className="flex flex-col justify-center gap-5 my-[100px]">
            <div className="flex flex-col align-middle justify-center text-center sm:text-left">
              <h1 className="sm:text-[40px] text-[25px] font-bold leading-normal">
                Login to your Account
              </h1>
              <h3 className=" text-zinc-500 text-[18px] sm:text-xl font-normal">
                Welcome back! Select method to log in:
              </h3>
            </div>
            <div className="sm:flex-row flex-col items-center flex sm:justify-between align-middle gap-[40px]">
              <div className="flex align-middle justify-center gap-2">
                <button className=" flex justify-center items-center w-[215px] h-[60px] gap-5 border-2 border-indigo-400 text-[22px] font-medium text-zinc-950 border-opacity-50 rounded-[10px]">
                  <Image
        ...
        <div className="bg-slate-700  w-[720px] h-[824px] shadow-2xl rounded-tr-[3em] rounded-br-[3em] hidden sm:block">
